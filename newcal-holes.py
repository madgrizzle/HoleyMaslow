...
numberOfIterations = 5000000  # reduced number of iterations
...
while(errorMagnitude > acceptableTolerance and n < numberOfIterations):
	...
	if (holePattern == 3):
		LChainErrorHole5 = LChainLengthHole5Est - LChainLengthHole5
		LChainErrorHole6 = LChainLengthHole6Est - LChainLengthHole6
		LChainErrorHole7 = LChainLengthHole7Est - LChainLengthHole7
		LChainErrorHole8 = LChainLengthHole8Est - LChainLengthHole8
		RChainErrorHole5 = RChainLengthHole5Est - RChainLengthHole5
		RChainErrorHole6 = RChainLengthHole6Est - RChainLengthHole6
		RChainErrorHole7 = RChainLengthHole7Est - RChainLengthHole7
		RChainErrorHole8 = RChainLengthHole8Est - RChainLengthHole8
